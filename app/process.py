...
def process_special_tags(html):
  ...
  html = re.sub('\[assets\]([^\[]*)\[/assets\]', '<div class="page-info" data-asset-title="\\1"><div class="page-info-icon"><i class="material-icons">file_download</i></div><div class="page-info-content"><a class="page-info-content-label">Download</a><div class="page-info-content-filesize"></div></div></div>', html, ALL)
