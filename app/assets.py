...
MESSAGING_IDENTIFIERS = (
    ...
    ('_PROMO_1PK_', '1 Pack Promotional (UK Only)'),
    ('_PROMO_2PK_', '2 Pack Promotional (UK Only)'),
    ('_PROMO_', 'Promotional'),
    ('_SEARCH_', 'Search'),
    ('_SOCIALMEDIA_', 'Social media'),
    ('_STANDALONE_1PK_', '1 Pack Standalone (UK Only)'),
    ('_STANDALONE_2PK_', '2 Pack Standalone (UK Only)'),
    ('_STANDALONE_', 'Standalone'),
    ('_STDV1_', 'Standard Single'),
    ('_STDV2_', 'Standard Device'),
    ('_STDV3_', 'Standard Multipack'),
    ('_STD_1PK_', '1 Pack Standard (UK Only)'),
